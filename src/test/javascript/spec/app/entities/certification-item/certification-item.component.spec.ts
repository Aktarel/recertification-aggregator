...
import { CertificationItemComponent } from 'app/entities/certification-item/certification-item.component';
...
describe('Component Tests', () => {
  describe('CertificationItem Management Component', () => {
    let comp: CertificationItemComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(CertificationItemComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      spyOn(service, 'query').and.returnValue(
        of(
          new HttpResponse({
            body: [new CertificationItem(123)],
            headers
          })
        )
      );
      ...
      expect(comp.certificationItems[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
